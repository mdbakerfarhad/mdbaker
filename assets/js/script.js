$(document).ready(function () {
    ...
    $("#contact-form").submit(function (event) {
        ...
        emailjs.sendForm('service_bbo5qt6', 'template_knkp7gd', '#contact-form')
...
var typed = new Typed(".typing-text1", {
    strings: ["✨ Living in the Moment ⚡", "✨ Turning Dreams into Reality 💟" , "✨ Disappearing into the Unknown Tomorrow 🌙 "],
    loop: true,
    typeSpeed: 60,
    backSpeed: 1,
    backDelay: 300,
...
function showProjects(projects) {
    ...
    projects.slice(0, 10).filter(project => project.category != "android").forEach(project => {
        projectHTML += `
        <div class="box tilt">
      <img draggable="false" src="https://github.com/mdbakerfarhad/mdbaker/tree/main/assets/images/projects/${project.image}.png" alt="project" />
      <div class="content">
        <div class="tag">
        <h3>${project.name}</h3>
        </div>
